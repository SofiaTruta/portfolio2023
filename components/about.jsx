    ...
    return (
        <>
            <div className="py-20" id="about">
                ...
                <p className="text-base leading-relaxed xl:text-lg">Recently completed <a href="https://generalassemb.ly/"><span className="underline">General Assembly</span></a>&apos;s Software Engineering bootcamp, I have learned the fundamentals of Full Stack software development (JavaScript, React, Vue.js, Express.js, Python, Django).</p>
            </div>
