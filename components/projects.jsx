        ...
        <div id="projects" className="py-20">
            ...
            <div>
                ...
                <div className="mb-10 flex flex-col p-1 animate-moveUpwards animated-element">
                    ...
                    <p className="text-base leading-relaxed mb-2">Selected Backend contributions: User Router and Controllers, as well as contributions to the dailyWorkouts Controller.
                    </p>
                    <p className="text-base leading-relaxed mb-2">Selected Frontend contributions: full responsibility over landing page and authentication, as well as Home page styling and functionality. 
                    </p>
                    <div className="inline-flex">
